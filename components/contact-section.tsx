    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <div className="flex-1 flex flex-col justify-between w-full">
                <div>
                  ...
                  <p className="text-base font-semibold text-foreground mb-6">
                    support@ljmagnet.com.au
                  </p>
                </div>
                <Button
                  size="lg"
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 text-base py-6"
                  asChild
                >
          ...
          <Card className="p-10 hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 bg-gradient-to-br from-green-50/50 to-white dark:from-green-950/20 dark:to-background">
            <div className="flex flex-col items-center text-center space-y-6 h-full">
              ...
              <div className="flex-1 flex flex-col justify-between w-full">
                ...
                <Button
                  size="lg"
                  className="w-full bg-green-500 hover:bg-green-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 text-base py-6"
                  asChild
                >
          ...
          <Card className="p-10 hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 bg-gradient-to-br from-gray-50/50 to-white dark:from-gray-900/20 dark:to-background">
            {/* Services */}
            <div className="pt-4 grid grid-cols-2 md:grid-cols-2 
            md: gap-3 justify-between max-w-5xl mx-auto">
              ...
              <div className="flex flex-col items-center gap-3 p-5 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 hover:from-purple-500/20 hover:to-purple-600/10 transition-all duration-300 hover:scale-105 border border-purple-500/20">
